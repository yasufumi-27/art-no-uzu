...
- TOP の「一本の線の人生」（`components/LifeLine.jsx`）：左の余白に一本の線をスクロールで描き進め、21歳(2015)→100歳(2094)の80年を表現。10年ごとに渦を描き、年齢とともに線が震える
  - それ以前に試した「右下の80年ゲージ（常時回転・80点）」は方向性が違うとのことで撤去（2026-09-15）
